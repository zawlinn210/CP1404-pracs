...
bigger_numbers = [number for number in numbers if number > 9]
...
long_words = [word for word in full_names if len(word) > 11]
print(long_words)
last_name = (f"{long_words[0][6:12]} {long_words[1][5:12]} {long_words[2][4:12]}".split())
text = ", ".join(last_name)
print(text)